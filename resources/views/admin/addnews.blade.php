...
<div class="content-wrapper">
	...
	<div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <!-- form start -->
            <form role="form" method="POST" action="{{ route('adminnews.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <!-- Title -->
                    ...
                    <!-- Hashtag -->
                     <div class="form-group">
                        <label>Hashtag</label>
                        <input type="text" class="form-control" name="hashtag" placeholder="Enter Hashtag">
                    </div>
                    <!-- /Hashtag -->
